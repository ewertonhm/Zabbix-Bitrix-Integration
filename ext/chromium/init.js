...
function getModelList()
{
  return new Promise(resolve => {
    ...
    xmlHttp.open( "POST", 'http://192.168.65.145/api/get_models/', true ); // false for synchronous request
...
function sendTaskData(title,description,model,alarms){
  ...
  xmlHttp.open( "POST", 'http://192.168.65.145/api/set_task/', false ); // false for synchronous request
  ...
  //xmlHttp.setRequestHeader("Access-Control-Allow-Origin","http://192.168.65.145");
