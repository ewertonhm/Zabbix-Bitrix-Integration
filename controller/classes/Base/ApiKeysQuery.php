...
use \ApiKeys as ChildApiKeys;
use \ApiKeysQuery as ChildApiKeysQuery;
use \Exception;
use \PDO;
use Map\ApiKeysTableMap;
 ...
 *
 * @method     ChildApiKeys[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildApiKeys objects based on current ModelCriteria
 * @psalm-method ObjectCollection&\Traversable<ChildApiKeys> find(ConnectionInterface $con = null) Return ChildApiKeys objects based on current ModelCriteria
 * @method     ChildApiKeys[]|ObjectCollection findById(int $id) Return ChildApiKeys objects filtered by the id column
 * @psalm-method ObjectCollection&\Traversable<ChildApiKeys> findById(int $id) Return ChildApiKeys objects filtered by the id column
 * @method     ChildApiKeys[]|ObjectCollection findByApiKey(string $api_key) Return ChildApiKeys objects filtered by the api_key column
 * @psalm-method ObjectCollection&\Traversable<ChildApiKeys> findByApiKey(string $api_key) Return ChildApiKeys objects filtered by the api_key column
...
abstract class ApiKeysQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\ApiKeysQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\ApiKeys', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, api_key FROM api_keys WHERE id = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildApiKeysQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(ApiKeysTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ApiKeysTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ApiKeysTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByApiKey($apiKey = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ApiKeysTableMap::COL_API_KEY, $apiKey, $comparison);
    }
