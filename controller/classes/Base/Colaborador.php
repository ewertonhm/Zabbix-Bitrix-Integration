...
/**
 * Base class that represents a row from the 'colaborador' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Colaborador implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ColaboradorTableMap';
    ...
    /**
     * Initializes internal state of Base\Colaborador object.
     */
    ...
    /**
     * Compares this with another <code>Colaborador</code> instance.  If
     * <code>obj</code> is an instance of <code>Colaborador</code>, delegates to
     * <code>equals(Colaborador)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ColaboradorTableMap::COL_ID] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[ColaboradorTableMap::COL_NOME] = true;
        }
    ...
    public function setBitrixId($v)
    {
        ...
        if ($this->bitrix_id !== $v) {
            $this->bitrix_id = $v;
            $this->modifiedColumns[ColaboradorTableMap::COL_BITRIX_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ColaboradorTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ColaboradorTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildColaboradorQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Colaborador::setDeleted()
     * @see Colaborador::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildColaboradorQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ColaboradorTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ColaboradorTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ColaboradorTableMap::COL_ID . ')');
        }
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('colaborador_id_seq')");
        ...
        if ($this->isColumnModified(ColaboradorTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ColaboradorTableMap::COL_NOME)) {
    ...
    {
        $pos = ColaboradorTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Colaborador'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Colaborador'][$this->hashCode()] = true;
        $keys = ColaboradorTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNome(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Colaborador The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ColaboradorTableMap::COL_ID)) {
            $criteria->add(ColaboradorTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ColaboradorTableMap::COL_NOME)) {
            $criteria->add(ColaboradorTableMap::COL_NOME, $this->nome);
        }
        if ($this->isColumnModified(ColaboradorTableMap::COL_BITRIX_ID)) {
    ...
    {
        $criteria = ChildColaboradorQuery::create();
        $criteria->add(ColaboradorTableMap::COL_ID, $this->id);
    ...
    public function setColaboradorUnidades(Collection $colaboradorUnidades, ConnectionInterface $con = null)
    {
        ...
        foreach ($colaboradorUnidadesToDelete as $colaboradorUnidadeRemoved) {
            $colaboradorUnidadeRemoved->setColaborador(null);
        }
    ...
    protected function doAddColaboradorUnidade(ChildColaboradorUnidade $colaboradorUnidade)
    {
        ...
        $colaboradorUnidade->setColaborador($this);
    }
    ...
    public function removeColaboradorUnidade(ChildColaboradorUnidade $colaboradorUnidade)
    {
        if ($this->getColaboradorUnidades()->contains($colaboradorUnidade)) {
            ...
            $colaboradorUnidade->setColaborador(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildColaboradorUnidade}> List of ChildColaboradorUnidade objects
     */
    public function getColaboradorUnidadesJoinUnidade(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildColaboradorUnidadeQuery::create(null, $criteria);
    ...
    public function setTasks(Collection $tasks, ConnectionInterface $con = null)
    {
        ...
        foreach ($tasksToDelete as $taskRemoved) {
            $taskRemoved->setColaborador(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildTask}> List of ChildTask objects
     */
    public function getTasksJoinUnidade(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTaskQuery::create(null, $criteria);
        $query->joinWith('Unidade', $joinBehavior);
    ...
    public function setTaskAccomplices(Collection $taskAccomplices, ConnectionInterface $con = null)
    {
        ...
        foreach ($taskAccomplicesToDelete as $taskAccompliceRemoved) {
            $taskAccompliceRemoved->setColaborador(null);
        }
    ...
    protected function doAddTaskAccomplice(ChildTaskAccomplice $taskAccomplice)
    {
        ...
        $taskAccomplice->setColaborador($this);
    }
    ...
    public function removeTaskAccomplice(ChildTaskAccomplice $taskAccomplice)
    {
        if ($this->getTaskAccomplices()->contains($taskAccomplice)) {
            ...
            $taskAccomplice->setColaborador(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildTaskAccomplice}> List of ChildTaskAccomplice objects
     */
    public function getTaskAccomplicesJoinTask(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTaskAccompliceQuery::create(null, $criteria);
    ...
    public function setTaskAuditors(Collection $taskAuditors, ConnectionInterface $con = null)
    {
        ...
        foreach ($taskAuditorsToDelete as $taskAuditorRemoved) {
            $taskAuditorRemoved->setColaborador(null);
        }
    ...
    protected function doAddTaskAuditor(ChildTaskAuditor $taskAuditor)
    {
        ...
        $taskAuditor->setColaborador($this);
    }
    ...
    public function removeTaskAuditor(ChildTaskAuditor $taskAuditor)
    {
        if ($this->getTaskAuditors()->contains($taskAuditor)) {
            ...
            $taskAuditor->setColaborador(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildTaskAuditor}> List of ChildTaskAuditor objects
     */
    public function getTaskAuditorsJoinTask(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTaskAuditorQuery::create(null, $criteria);
        $query->joinWith('Task', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(ColaboradorTableMap::DEFAULT_STRING_FORMAT);
    }
