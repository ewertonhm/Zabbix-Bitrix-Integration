...
/**
 * Base class that represents a row from the 'tecnologia' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Tecnologia implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TecnologiaTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildColaborador> Collection to store aggregation of ChildColaborador objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildColaborador>
     */
    protected $colaboradorsScheduledForDeletion = null;

    /**
     * Initializes internal state of Base\Tecnologia object.
     */
    ...
    /**
     * Compares this with another <code>Tecnologia</code> instance.  If
     * <code>obj</code> is an instance of <code>Tecnologia</code>, delegates to
     * <code>equals(Tecnologia)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\Tecnologia The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TecnologiaTableMap::COL_ID] = true;
        }
    ...
    public function setTecnologia($v)
    {
        ...
        if ($this->tecnologia !== $v) {
            $this->tecnologia = $v;
            $this->modifiedColumns[TecnologiaTableMap::COL_TECNOLOGIA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TecnologiaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TecnologiaTableMap::translateFieldName('Tecnologia', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = TecnologiaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Tecnologia'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTecnologiaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Tecnologia::setDeleted()
     * @see Tecnologia::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTecnologiaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TecnologiaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->colaboradorsScheduledForDeletion !== null) {
                if (!$this->colaboradorsScheduledForDeletion->isEmpty()) {
                    foreach ($this->colaboradorsScheduledForDeletion as $colaborador) {
                        // need to save related object because we set the relation to null
                        $colaborador->save($con);
                    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('tecnologia_id_seq')");
        ...
        if ($this->isColumnModified(TecnologiaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TecnologiaTableMap::COL_TECNOLOGIA)) {
            $modifiedColumns[':p' . $index++]  = 'tecnologia';
        }

        $sql = sprintf(
            'INSERT INTO tecnologia (%s) VALUES (%s)',
    ...
    {
        $pos = TecnologiaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Tecnologia'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tecnologia'][$this->hashCode()] = true;
        $keys = TecnologiaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getTecnologia(),
        );
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Tecnologia The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TecnologiaTableMap::COL_ID)) {
            $criteria->add(TecnologiaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TecnologiaTableMap::COL_TECNOLOGIA)) {
            $criteria->add(TecnologiaTableMap::COL_TECNOLOGIA, $this->tecnologia);
        }
    ...
    {
        $criteria = ChildTecnologiaQuery::create();
        $criteria->add(TecnologiaTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tecnologia (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tecnologia Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTecnologia is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildColaborador[] List of ChildColaborador objects
     * @phpstan-return ObjectCollection&\Traversable<ChildColaborador> List of ChildColaborador objects
     * @throws PropelException
     */
        ...
        if (null === $this->collColaboradors || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collColaboradors) {
                    ...
                    $collColaboradors = new $collectionClassName;
                    $collColaboradors->setModel('\Colaborador');

                    return $collColaboradors;
                }
            } else {
                $collColaboradors = ChildColaboradorQuery::create(null, $criteria)
                    ->filterByTecnologia($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTecnologia The current object (for fluent API support)
     */
    public function setColaboradors(Collection $colaboradors, ConnectionInterface $con = null)
    {
        ...
        foreach ($colaboradorsToDelete as $colaboradorRemoved) {
            $colaboradorRemoved->setTecnologia(null);
        }
    ...
    protected function doAddColaborador(ChildColaborador $colaborador)
    {
        ...
        $colaborador->setTecnologia($this);
    }
    ...
    public function removeColaborador(ChildColaborador $colaborador)
    {
        if ($this->getColaboradors()->contains($colaborador)) {
            ...
            $this->colaboradorsScheduledForDeletion[]= $colaborador;
            $colaborador->setTecnologia(null);
        }
     ...
     * Otherwise if this Tecnologia is new, it will return
     * an empty collection; or if this Tecnologia has previously
     * been saved, it will retrieve related Colaboradors from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Tecnologia.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildColaborador}> List of ChildColaborador objects
     */
    public function getColaboradorsJoinUnidade(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildColaboradorQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(TecnologiaTableMap::DEFAULT_STRING_FORMAT);
    }
