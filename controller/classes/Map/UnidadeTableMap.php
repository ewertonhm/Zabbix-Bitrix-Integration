...
class UnidadeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.UnidadeTableMap';
     ...
     */
    const OM_CLASS = '\\Unidade';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Unidade';
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'unidade.id' => 'ID',
        'UnidadeTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Nome' => 'NOME',
        'Unidade.Nome' => 'NOME',
        'nome' => 'NOME',
        'unidade.nome' => 'NOME',
        'UnidadeTableMap::COL_NOME' => 'NOME',
        'COL_NOME' => 'NOME',
        'Sigla' => 'SIGLA',
        'Unidade.Sigla' => 'SIGLA',
        'sigla' => 'SIGLA',
        'unidade.sigla' => 'SIGLA',
        'UnidadeTableMap::COL_SIGLA' => 'SIGLA',
        'COL_SIGLA' => 'SIGLA',
    ];
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Unidade');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('unidade_id_seq');
        // columns
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(UnidadeTableMap::COL_ID);
            $criteria->removeSelectColumn(UnidadeTableMap::COL_NOME);
            $criteria->removeSelectColumn(UnidadeTableMap::COL_SIGLA);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.nome');
            $criteria->removeSelectColumn($alias . '.sigla');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Unidade) { // it's a model object
