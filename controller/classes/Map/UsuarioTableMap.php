...
class UsuarioTableMap extends TableMap
{
     ...
     */
    const COL_API_KEY = 'usuario.api_key';

    /**
     * the column name for the bitrix_id field
     */
    const COL_BITRIX_ID = 'usuario.bitrix_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'Senha', 'Nome', 'ApiKey', 'BitrixId', 'Admin', ),
        self::TYPE_CAMELNAME     => array('id', 'email', 'senha', 'nome', 'apiKey', 'bitrixId', 'admin', ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID, UsuarioTableMap::COL_EMAIL, UsuarioTableMap::COL_SENHA, UsuarioTableMap::COL_NOME, UsuarioTableMap::COL_API_KEY, UsuarioTableMap::COL_BITRIX_ID, UsuarioTableMap::COL_ADMIN, ),
        self::TYPE_FIELDNAME     => array('id', 'email', 'senha', 'nome', 'api_key', 'bitrix_id', 'admin', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Email' => 1, 'Senha' => 2, 'Nome' => 3, 'ApiKey' => 4, 'BitrixId' => 5, 'Admin' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'email' => 1, 'senha' => 2, 'nome' => 3, 'apiKey' => 4, 'bitrixId' => 5, 'admin' => 6, ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID => 0, UsuarioTableMap::COL_EMAIL => 1, UsuarioTableMap::COL_SENHA => 2, UsuarioTableMap::COL_NOME => 3, UsuarioTableMap::COL_API_KEY => 4, UsuarioTableMap::COL_BITRIX_ID => 5, UsuarioTableMap::COL_ADMIN => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'email' => 1, 'senha' => 2, 'nome' => 3, 'api_key' => 4, 'bitrix_id' => 5, 'admin' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'COL_NOME' => 'NOME',
        'ApiKey' => 'API_KEY',
        'Usuario.ApiKey' => 'API_KEY',
        'apiKey' => 'API_KEY',
        'usuario.apiKey' => 'API_KEY',
        'UsuarioTableMap::COL_API_KEY' => 'API_KEY',
        'COL_API_KEY' => 'API_KEY',
        'api_key' => 'API_KEY',
        'usuario.api_key' => 'API_KEY',
        'BitrixId' => 'BITRIX_ID',
        'Usuario.BitrixId' => 'BITRIX_ID',
        'bitrixId' => 'BITRIX_ID',
        'usuario.bitrixId' => 'BITRIX_ID',
        'UsuarioTableMap::COL_BITRIX_ID' => 'BITRIX_ID',
        'COL_BITRIX_ID' => 'BITRIX_ID',
        'bitrix_id' => 'BITRIX_ID',
        'usuario.bitrix_id' => 'BITRIX_ID',
        'Admin' => 'ADMIN',
        'Usuario.Admin' => 'ADMIN',
        'admin' => 'ADMIN',
        'usuario.admin' => 'ADMIN',
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioTableMap::COL_API_KEY);
            $criteria->addSelectColumn(UsuarioTableMap::COL_BITRIX_ID);
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(UsuarioTableMap::COL_API_KEY);
            $criteria->removeSelectColumn(UsuarioTableMap::COL_BITRIX_ID);
