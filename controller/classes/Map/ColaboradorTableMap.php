...
class ColaboradorTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'colaborador.id';

    /**
     * the column name for the nome field
     */
    const COL_NOME = 'colaborador.nome';
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'colaborador.id' => 'ID',
        'ColaboradorTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'Nome' => 'NOME',
        'Colaborador.Nome' => 'NOME',
        'nome' => 'NOME',
        'colaborador.nome' => 'NOME',
        'ColaboradorTableMap::COL_NOME' => 'NOME',
        'COL_NOME' => 'NOME',
        'BitrixId' => 'BITRIX_ID',
        'Colaborador.BitrixId' => 'BITRIX_ID',
        'bitrixId' => 'BITRIX_ID',
        'colaborador.bitrixId' => 'BITRIX_ID',
        'ColaboradorTableMap::COL_BITRIX_ID' => 'BITRIX_ID',
    ...
    public function initialize()
    {
        ...
        $this->setPrimaryKeyMethodInfo('colaborador_id_seq');
        // columns
  ...
  array (
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ColaboradorTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ColaboradorTableMap::COL_ID) && $criteria->keyContainsValue(ColaboradorTableMap::COL_ID) ) {
